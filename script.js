...
document.getElementById("add-workout-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("workout-user-id").value;
    const workout_type = document.getElementById("workout-type").value;
    const duration = document.getElementById("workout-duration").value;
    const calories_burned = document.getElementById("workout-calories").value;
...
// Fetch Workouts by User ID when the form is submitted
document.getElementById("workout-id-form").addEventListener("submit", async (e) => {
    ...
    try {
        ...
        workouts.forEach(workout => {
            ...
            row.insertCell(4).textContent = workout.notes;
...
async function editWorkout(workoutId) {
    ...
    try {
        ...
        document.getElementById("update-workout-user-id").value = workout.user_id || '';
        ...
        document.getElementById("update-workout-notes").value = workout.notes || '';
...
document.getElementById("update-workout-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("update-workout-user-id").value.trim();
    ...
    const notes = document.getElementById("update-workout-notes").value.trim();
...
document.getElementById("add-workout-with-exercises-form").addEventListener("submit", async (e) => {
    ...
    const notes = document.getElementById("transaction-workout-notes").value;
    ...
    try {
        ...
        const response = await fetch(`${BASE_URL}/workouts_with_exercises`, {
            ...
            body: JSON.stringify({
                user_id,
                workout_details: { workout_type, duration, calories_burned, notes },
                exercises,
            }),
        });
...
document.getElementById("diet-user-id-form").addEventListener("submit", async (e) => {
    ...
    const userId = document.getElementById("diet-user-id-input").value;
    ...
    try {
        ...
        dietEntries.forEach(entry => {
            const row = tableBody.insertRow();
            row.insertCell(0).textContent = entry.diet_id;
            row.insertCell(1).textContent = entry.user_id;
            row.insertCell(2).textContent = entry.meal_type;
            row.insertCell(3).textContent = entry.calories;
            row.insertCell(4).textContent = entry.description;
...
document.getElementById("add-diet-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("diet-user-id").value;
    const meal_type = document.getElementById("diet-meal-type").value;
    const calories = document.getElementById("diet-calories").value;
    const description = document.getElementById("diet-description").value;
...
async function editDiet(dietId) {
    ...
    try {
        ...
        document.getElementById("update-diet-user-id").value = dietEntry.user_id || '';
        ...
        document.getElementById("update-diet-description").value = dietEntry.description || '';
...
document.getElementById("update-diet-form").addEventListener("submit", async (e) => {
    ...
    const description = document.getElementById("update-diet-description").value;
...
document.getElementById("goal-user-id-form").addEventListener("submit", async (e) => {
    ...
    const userId = document.getElementById("goal-user-id-input").value;
    ...
    try {
        ...
        goals.forEach(goal => {
            const row = tableBody.insertRow();
            row.insertCell(0).textContent = goal.goal_id;
            row.insertCell(1).textContent = goal.goal_type;
            row.insertCell(2).textContent = goal.target_value;
            row.insertCell(3).textContent = goal.current_progress;
            row.insertCell(4).textContent = goal.deadline;
            row.insertCell(5).textContent = goal.status;
...
document.getElementById("add-goal-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("goal-user-id").value;
...
async function editGoal(goalId) {
    ...
    try {
        ...
        const goalArray = await response.json();

        // Find the goal object by its ID
        const goal = Array.isArray(goalArray) 
            ? goalArray.find(g => g.goal_id === goalId) 
            : goalArray;
        ...
        // Populate the form fields
        document.getElementById("update-goal-id").value = goal.goal_id;
        document.getElementById("update-goal-user-id").value = goal.user_id;
...
document.getElementById("update-goal-form").addEventListener("submit", async (e) => {
    ...
    const goal_id = document.getElementById("update-goal-id").value;
    const user_id = document.getElementById("update-goal-user-id").value;
...
document.getElementById("progress-user-id-form").addEventListener("submit", async (e) => {
    ...
    const userId = document.getElementById("progress-user-id-input").value;
    ...
    try {
        ...
        progressEntries.forEach((progress) => {
            const row = tableBody.insertRow();
            row.insertCell(0).textContent = progress.progress_id;
            row.insertCell(1).textContent = progress.weight;
            row.insertCell(2).textContent = progress.workout_count;
            row.insertCell(3).textContent = progress.calories_burned;
            row.insertCell(4).textContent = new Date(progress.date).toLocaleDateString();
            row.insertCell(5).textContent = progress.goal_id || "N/A";
...
document.getElementById("add-progress-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("progress-user-id").value;
    ...
    const goal_id = document.getElementById("progress-goal-id").value;
...
async function editProgress(progressId) {
    ...
    try {
        ...
        document.getElementById("update-progress-user-id").value = progress.user_id;
        ...
        document.getElementById("update-progress-goal-id").value = progress.goal_id || '';
...
document.getElementById("update-progress-form").addEventListener("submit", async (e) => {
    ...
    const user_id = document.getElementById("update-progress-user-id").value;
    ...
    const goal_id = document.getElementById("update-progress-goal-id").value;
